...
\033[0;92m | |__| |  /  \  |  \| | | |  \ \_/ //  \   
\033[0;92m |  __  | / /\ \ | . ` | | |   \   // /\ \  
\033[0;92m | |  | |/ ____ \| |\  |_| |_   | |/ ____ \ 
\033[0;92m |_|  |_/_/    \_\_| \_|_____|  |_/_/    \_\
                                            
  \033[1;92m×××××××××××××××××\033[1;93m××××××××××××××\033[1;92m××××××××××××××××××
  \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mHANIYA BALOCH   \033[1;92m|
  \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m  Fatima Shehzadi            \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35m Haniyabaloch0786             \033[1;92m|
  \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36mRandom Tools          \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mPRO CLONER                \033[1;92m|
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}HANIYA BALOCH')
    print(f'{M}║══[ [•] YOR IP    : ')
    print(f'{M}║══[ [•] VERSION   : {H}1.0.9')
    print(f'{M}╚══[ [•] TOOL NAME : {H}PRO CLONER\n')
    ...
    print(f"║══[{H}[{M}F{H}] \033[1;92mFOLLOWING ME ON GITHUB{Haniyabaloch0786}[>/]")
    print(f"║══[{H}[{M}Y{H}] \033[1;92mFOLLOWING ME ON FB{Shahzadi.Pari786} ")
    print(f"╚══[{H}[{M}U{H}] {M}UPDATE PROGRAMME ")
    sh = input("    \033[0;91m(#)\033[0;92m CHOOSE : ")
    if sh =='1':
       os.system('xdg-open https://www.facebook.com/Shahzadi.Pari786/?ref=share_id_link')
       sh6()
    if sh =='2':
       os.system('xdg-open https://www.facebook.com/Shahzadi.Pari786/?ref=share_id_link')
       sh7()
    ...
    if sh =='U':
       ...
       main()
        ...
        os.system('xdg-open https://github.com/Haniyabaloch0786')
        main()
